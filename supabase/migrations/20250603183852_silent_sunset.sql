/*
  ...
  1. New Tables
    - `batches` - Stores all pharmaceutical batches with their metadata
    - `batch_transfers` - Records ownership transfers between wallets
    - `batch_flags` - Records suspicious batches flagged by regulators
